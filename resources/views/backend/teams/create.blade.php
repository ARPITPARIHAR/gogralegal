...
@section('meta_title',__('Add Team Member'))

@section('page_name',__('Add Team Member'))

@section('page_description',__('Add Team Member'))
@section('name')
    <li class="breadcrumb-item">
        <a href="{{ route('admin.dashboard') }}"> <i class="feather icon-home"></i> </a>
    </li>
    <li class="breadcrumb-item"><a href="#!">{{ __('Add Team Member') }}</a>
    </li>
@endsection
@section('content')
<div class="row">
