...
@section('meta_title',__('Add Case Study'))

@section('page_name',__('Add Case Study'))

@section('page_description',__('Add Case Study'))
@section('name')
    <li class="breadcrumb-item">
        <a href="{{ route('admin.dashboard') }}"> <i class="feather icon-home"></i> </a>
    </li>
    <li class="breadcrumb-item"><a href="#!">{{ __('Add Case Study') }}</a>
    </li>
@endsection
@section('content')
<div class="row">
