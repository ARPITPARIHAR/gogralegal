...
@section('meta_title',__('Add Law'))

@section('page_name',__('Add Law'))

@section('page_description',__('Add Law'))
@section('name')
    <li class="breadcrumb-item">
        <a href="{{ route('admin.dashboard') }}"> <i class="feather icon-home"></i> </a>
    </li>
    <li class="breadcrumb-item"><a href="#!">{{ __('Add Law') }}</a>
    </li>
@endsection
@section('content')
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="card">
            ...
            <div class="card-block">
                <form action="{{ route('admin.laws.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
