    ...
    <div class="col-sm-12">
        ...
        <div class="card">
            <div class="card-header row">
                <div class="col-sm-2">
                    <a href="{{ route('admin.sliders.create') }}" class="btn btn-sm btn-primary">{{ __('Add Slider') }}</a>
                </div>
            </div>
                    ...
                    <table id="simpletable" class="table table-striped table-bordered nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $slider->brief_description }}</td>
                                <td>{{ date('d-m-Y h:iA',strtotime($slider->updated_at)) }}</td>
                                <td>
                                    <a href="{{ route('admin.sliders.edit',encrypt($slider->id)) }}" class="btn btn-sm btn-primary">{{ __('Edit') }}</a>
                                    <a href="{{ route('admin.sliders.delete',encrypt($slider->id)) }}" class="btn btn-sm btn-danger">{{ __('Delete') }}</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
